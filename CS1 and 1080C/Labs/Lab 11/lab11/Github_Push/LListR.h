...
class LListR{
  ...
  int counter(nodeR_t * temp)const
  {
      int count;
      if (temp == NULL)
      {
  ...
  void setAt(int value, unsigned pos, nodeR_t* node){
    ...
    bool equal(nodeR_t* temp1, nodeR_t* temp2)const
    {
