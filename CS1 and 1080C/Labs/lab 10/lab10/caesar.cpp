...
string caesar::encrypter(string Line, string cipher_key)	//encrypt and save
{
...
string caesar::decrypter(string Line, string cipher_key) //decrypt and save
{
    int count = findcount(cipher_key);
    string NewLine = Line;
    for(int i = 0; i < Line.size(); i++)
...
void caesar::encrypter(string input_file, string encrypted_file, string cipher_key) // do the caesar 
{
...
void caesar::decrypter(string encrypted_file, string decrypted_file, string cipher_key) //decrypt the ceasar
{
